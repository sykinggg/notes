import{a as n}from"./app.60f4e93a.js";import{_ as s}from"./plugin-vue_export-helper.21dcd24c.js";const a={},p=n(`<h1 id="updateforwardref" tabindex="-1"><a class="header-anchor" href="#updateforwardref" aria-hidden="true">#</a> updateForwardRef</h1><p>ForwardRef\u662F\u901A\u8FC7<code>React.forwardRef</code>\u521B\u5EFA\u7684\uFF0C\u8BE6\u7EC6\u7684\u8BF7\u770B<a href="">forwardRef</a></p><div class="language-javascript ext-js line-numbers-mode"><pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">updateForwardRef</span><span class="token punctuation">(</span>
