...
### 基础配置
[Define](/esbuild/api/transform#define)
[Format](/esbuild/api/transform#format)
[Loader](/esbuild/api/transform#loader)
[Minify](/esbuild/api/transform#minify)
[SourceMap](/esbuild/api/transform#sourcemap)
[Target](/esbuild/api/transform#target)
### 高级配置
[Banner](/esbuild/api/transform#banner)
[Charset](/esbuild/api/transform#charset)
[Color](/esbuild/api/transform#color)
[Footer](/esbuild/api/transform#footer)
[Global name](/esbuild/api/transform#global-name)
[JSX](/esbuild/api/transform#jsx)
[JSX factory](/esbuild/api/transform#jsx-factory)
[JSX fragment](/esbuild/api/transform#jsx-fragment)
[Keep names](/esbuild/api/transform#keep-names)
[Legal comments](/esbuild/api/transform#legal-comments)
[Log level](/esbuild/api/transform#log-level)
[Log limit](/esbuild/api/transform#log-limit)
[Pure](/esbuild/api/transform#pure)
[Source Root](/esbuild/api/transform#source-root)
[Sourcefile](/esbuild/api/transform#sourcefile)
[Sources Content](/esbuild/api/transform#sources-content)
[Tree shaking](/esbuild/api/transform#tree-shaking)
[Tsconfig raw](/esbuild/api/transform#tsconfig-raw)
...
### 基础配置
[Bundle](/esbuild/api/transform#bundle)
[Define](/esbuild/api/transform#define)
[Entry points](/esbuild/api/transform#entry-points)
[External](/esbuild/api/transform#external)
[Format](/esbuild/api/transform#format)
[Inject](/esbuild/api/transform#inject)
[Loader](/esbuild/api/transform#loader)
[Minify](/esbuild/api/transform#minify)
[Outdir](/esbuild/api/transform#outdir)
[Outfile](/esbuild/api/transform#outfile)
[Platform](/esbuild/api/transform#platform)
[Serve](/esbuild/api/transform#serve)
[Sourcemap](/esbuild/api/transform#sourcemap)
[Splitting](/esbuild/api/transform#splitting)
[Target](/esbuild/api/transform#target)
[Watch](/esbuild/api/transform#watch)
[Write](/esbuild/api/transform#write)

### 高级配置

[Allow overwrite](/esbuild/api/transform#allow-overwrite)
[Asset names](/esbuild/api/transform#asset-names)
[Banner](/esbuild/api/transform#banner)
[Charset](/esbuild/api/transform#charset)
[Chunk names](/esbuild/api/transform#chunk-names)
[Color](/esbuild/api/transform#color)
[Conditions](/esbuild/api/transform#conditions)
[Entry names](/esbuild/api/transform#entry-names)
[Footer](/esbuild/api/transform#footer)
[Global name](/esbuild/api/transform#global-name)
[Incremental](/esbuild/api/transform#incremental)
[JSX](/esbuild/api/transform#jsx)
[JSX factory](/esbuild/api/transform#jsx-factory)
[JSX fragment](/esbuild/api/transform#jsx-fragment)
[Keep names](/esbuild/api/transform#keep-names)
...
[Log level](/esbuild/api/transform#log-level)
[Log limit](/esbuild/api/transform#log-limit)
[Main fields](/esbuild/api/transform#main-fields)
[Metafile](/esbuild/api/transform#metafile)
[Node paths](/esbuild/api/transform#node-paths)
[Out extension](/esbuild/api/transform#out-extension)
[Outbase](/esbuild/api/transform#outbase)
[Preserve symlinks](/esbuild/api/transform#preserve-symlinks)
[Public path](/esbuild/api/transform#public-path)
[Pure](/esbuild/api/transform#pure)
[Resolve extensions](/esbuild/api/transform#resolve-extensions)
[Source Root](/esbuild/api/transform#source-root)
[Sourcefile](/esbuild/api/transform#sourcefile)
[Sources Content](/esbuild/api/transform#sources-content)
[Stdin](/esbuild/api/transform#stdin)
[Tree shaking](/esbuild/api/transform#tree-shaking)
[Tsconfig](/esbuild/api/transform#tsconfig)
[Working directory](/esbuild/api/transform#working-directory)
...
该领域来自如何将EcMasscript模块集成到node中的[提案](https://github.com/dherman/defense-of-dot-js/blob/f31319be735b21739756b87d551f6711bd7aa283/proposal)。因此，预计此字段中的文件路径是ECMAScript风格模块是合理的。node未采用此提议（Node使用`“type”`：`“module”`而不是），但主要是主要的捆绑程序采用，因为ECMAScript风格模块导致更好的[树抖动](./transform/#tree-shaking)，或拆除死亡代码。
