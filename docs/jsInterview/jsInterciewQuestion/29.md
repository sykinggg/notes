# 第29题：如何确保你的构造函数只能被new调用，而不能被普通调用
...
<!-- <img :src="$withBase('/assets/jsInterview/jsInterviewQuestion/01af393ccf114ccd85fb53f683f60ed2_tplv-k3u1fbpfcp-watermark.png')" alt="demo"/> -->
...
<!-- <img :src="$withBase('/assets/jsInterview/jsInterviewQuestion/673b0eb9b3124b63bc72066c0533f7d8_tplv-k3u1fbpfcp-watermark.png')" alt="demo"/> -->
...
<!-- <img :src="$withBase('/assets/jsInterview/jsInterviewQuestion/0dd72beb61194c61a61a22733e379802_tplv-k3u1fbpfcp-watermark.png')" alt="demo"/> -->
