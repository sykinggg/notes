...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><p>\u8FD9\u4E09\u4E2A\u5C5E\u6027\u5206\u522B\u7684\u7528\u5904\u662F\uFF1A</p><ul><li><p><code>alreadyCaptured</code>\u6807\u5FD7\u662F\u5426\u5B50\u6811\u4E2D\u5DF2\u7ECF\u6302\u8D77\u4E86</p></li><li><p><code>didTimeout</code>\u6807\u5FD7\u73B0\u5728\u662F\u6E32\u67D3\u7684\u4E3B\u8981\u5B50\u8282\u70B9\uFF0C\u8FD8\u662F<code>fallback</code>\u8282\u70B9\u3002\u8FD9\u4E2A\u4E3B\u8981\u662F\u5728\u975E<code>ConcurrentMode</code>\u4E2D\u7528\u5230</p></li><li><p><code>timedOutAt</code>\u5728\u6BCF\u6B21\u8BE5\u7EC4\u4EF6\u88AB<code>commit</code>\u7684\u65F6\u5019\u88AB\u8BBE\u7F6E\u4E3A\u5F53\u65F6\u7684\u65F6\u95F4</p></li></ul><p>\u9996\u5148\uFF0C\u7B2C\u4E00\u6B21\u6E32\u67D3\u8BE5\u7EC4\u4EF6\u7684\u65F6\u5019\uFF0C<code>state</code>\u80AF\u5B9A\u7B49\u4E8E<code>null</code>\uFF0C\u6240\u4EE5<code>nextDidTimeout</code>\u662F<code>false</code>\uFF0C\u800C\u4E14<code>current</code>\u662F<code>null</code>\uFF0C\u8D70\u7684\u5C31\u662F\u8FD9\u4E2A\u6D41\u7A0B\uFF1A</p><div class="language-javascript ext-js line-numbers-mode"><pre class="language-javascript"><code><span class="token comment">// Mount the primary children without an intermediate fragment fiber.</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br></div></div><p>\u53EA\u6709\u5728\u524D\u540E<code>didTimeout</code>\u4E0D\u540C\u7684\u65F6\u5019\u624D\u4F1A\u589E\u52A0<code>Update</code></p><div class="language-javascript ext-js line-numbers-mode"><pre class="language-javascript"><code>newDidTimeout <span class="token operator">=</span> newState<span class="token punctuation">.</span>didTimeout
<span class="token keyword">if</span> <span class="token punctuation">(</span>newDidTimeout<span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br></div></div><p>\u7ECF\u8FC7\u8FD9\u6837\u4E4B\u540E\uFF0C\u5728\u4E0B\u4E00\u6B21\u66F4\u65B0<code>SuspenseComponent</code>\u7684\u65F6\u5019\uFF0C<code>nextState</code>\u5C31\u7B49\u4E8E<code>null</code></p><blockquote><p>\u6E90\u7801</p></blockquote><div class="language-javascript ext-js line-numbers-mode"><pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">updateSuspenseComponent</span><span class="token punctuation">(</span>
