import{_ as n,a as s}from"./app.41ff10d5.js";const a={},p=s(`<h1 id="" tabindex="-1"><a class="header-anchor" href="#" aria-hidden="true">#</a></h1><h1 id="commitwork" tabindex="-1"><a class="header-anchor" href="#commitwork" aria-hidden="true">#</a> commitWork</h1><h2 id="commitupdate" tabindex="-1"><a class="header-anchor" href="#commitupdate" aria-hidden="true">#</a> commitUpdate</h2><div class="language-javascript ext-js line-numbers-mode"><pre class="language-javascript"><code><span class="token keyword">export</span> <span class="token keyword">function</span> <span class="token function">commitUpdate</span><span class="token punctuation">(</span>
